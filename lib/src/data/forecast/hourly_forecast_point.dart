// lib/src/data/forecast/hourly_forecast_point.dart

class HourlyForecastPoint {
  final int id;
  final int recordId;
  final int? landslideId;  // Thêm trường landslideId
  ...
  HourlyForecastPoint({
    ...
    this.landslideId,  // Thêm vào constructor
  ...
  factory HourlyForecastPoint.fromJson(Map<String, dynamic> json) {
    return HourlyForecastPoint(
      ...
      landslideId: json['landslide_id'],  // Parse từ JSON
  ...
  Map<String, dynamic> toJson() {
    return {
      'id': id,
      'record_id': recordId,
      'landslide_id': landslideId,  // Thêm vào JSON output
      'ten_diem': tenDiem,
      'vi_tri': viTri,
      'kinh_do': kinhDo,
      'vi_do': viDo,
